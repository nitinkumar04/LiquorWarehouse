CREATE TABLE [SFOut].[gvp__Account_Call__c]
(
	[Id]                                         char(18)       null,
    ...
    CONSTRAINT [PK_gvp__Account_Call__c] PRIMARY KEY ([gvp__External_Id__c])
