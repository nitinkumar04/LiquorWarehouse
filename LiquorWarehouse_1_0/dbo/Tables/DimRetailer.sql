CREATE TABLE [dbo].[DimRetailer] (
    ...
    KeyAccountChain1          nvarchar(100)    null,
    KeyAccountChain2          nvarchar(100)    null,
    LWKeyAccountChainFlag     int              not null default 0,
    LWSalesRepSKey            int              not null default -1,
    [BannerName]              NVARCHAR (50)     NULL,
    [BDNID]                   VARCHAR (35)     NULL,
    [SRSID]                   VARCHAR (35)     NULL,
    [ERPID]                   VARCHAR (35)     NULL,
    [ERP2ID]                  VARCHAR (35)     NULL,
    [TDLinxID]                VARCHAR (35)     NULL,
    ...
    [LWWineFlag]                INT              NULL,
    [LWLiquorFlag]              INT              NULL,
    [LWBeerFlag]                INT              NULL,
    [LWFranchiseFlag]           INT              NULL,
    [LWFoodTypeSKey]          INT              NULL,
    [LWTradeChannelSKey]      INT              NULL,
    [LWActiveFlag]              INT              NULL,
