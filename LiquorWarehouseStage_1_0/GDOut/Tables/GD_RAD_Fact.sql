CREATE TABLE [GDOut].[GD_RAD_Fact](
	...
	[RAD Key] [varchar](100) NULL,
	[RAD Source File] [varchar](50) NULL,
	[RAD POD Key] [varchar](100) NULL,
	[RAD Physical Cases] DECIMAL(14, 4) NULL,
	[RAD 9L Cases] DECIMAL(14, 4) NULL,
	[RAD Full Case Equivalent] DECIMAL(14, 4) NULL,
	[RAD Primary Volume] DECIMAL(14, 4) NULL,
	[RAD Secondary Volume] DECIMAL(14, 4) NULL,
	[RAD Extended Price 1] MONEY NULL,
	[RAD Custom 1] NVARCHAR(100) NULL,
	[RAD Custom 2] NVARCHAR(100) NULL,
	...
	[Sales Rep Dim Id] CHAR(18) NULL,
	[Currency Dim Id] [varchar](5) NULL,
	[RAD Invoice Number] [varchar](20) NULL,
	[RAD Outlet Key] [varchar](50) NULL,
	[RAD Dist Item Number] [varchar](30) NULL,
	[RAD Sales Rep Code] [varchar](50) NULL,
	[RAD Sales Rep Name] NVARCHAR(50) NULL,
	...
	[RAD Source System] [varchar](25) NULL,
