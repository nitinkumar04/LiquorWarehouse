CREATE TABLE [GDOut].[GD_Activity_Fact] (
    ...
    [Activity Name]               VARCHAR (20)   NULL,
    [Activity URL]                NVARCHAR (200) NULL,
    [Activity Compliance]         VARCHAR (20)   NULL,
    [Activity Current]            VARCHAR (10)   NULL,
    [Activity Description]        VARCHAR (800)  NULL,
    [Activity Group]              VARCHAR (500)  NULL,
    ...
    [Event ERF Received]          VARCHAR (MAX)  NULL,
    ...
    [Objective Results]           VARCHAR (100)  NULL,
    ...
    [Activity Custom 1]           NVARCHAR (200) NULL,
    [Activity Custom 2]           NVARCHAR (200) NULL,
    [Activity Custom 3]           NVARCHAR (200) NULL,
    [Activity Custom 4]           NVARCHAR (200) NULL,
    [Activity Custom 5]           NVARCHAR (200) NULL,
    ...
    [Image_URL_Dashboard]         VARCHAR (100)  NULL,
    [Image_URL_Table]             VARCHAR (50)   NULL,
