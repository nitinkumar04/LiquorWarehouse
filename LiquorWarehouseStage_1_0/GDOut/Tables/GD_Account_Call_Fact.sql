CREATE TABLE [GDOut].[GD_Account_Call_Fact](
	...
	[Account Call Custom 1]          [varchar](max)  NULL,
	[Account Call Custom 2]          [varchar](max)  NULL,
	[Account Call Custom 3]          [varchar](max)  NULL,
	[Account Call Custom 4]          [varchar](max)  NULL,
    [Account Call Custom 5]          [varchar](max)  NULL,
