...
begin
  ...
  truncate table sfin.LWAccountParentRecordsAsChildren
  ...
  insert into sfin.LWAccountParentRecordsAsChildren
    select distinct a.* 
    from sfin.Account a 
  ...
  update aprdac set
    ...
    from sfin.LWAccountParentRecordsAsChildren aprdac
  ...
  select
    ...
    a.LastModifiedDate,
    s.SourceID
  from sfin.LWAccountParentRecordsAsChildren a 
    inner join source s on s.sourcename = 'Salesforce'
