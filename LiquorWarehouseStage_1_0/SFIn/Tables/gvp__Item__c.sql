CREATE TABLE [SFIn].[gvp__Item__c] (
    ...
    [gvp__UPC_Code__c]                      VARCHAR (12)     NULL,
    [gvp__Units__c]                         DECIMAL(4, 1)              NULL,
    [gvp__Vintage__c]                       VARCHAR (20)     NULL,
    [gvp__BrandLookup__c]                   NVARCHAR (100)    NULL,
    [gvp__Item_Key__c]                      VARCHAR (20)     NULL,
