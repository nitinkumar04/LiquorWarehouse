CREATE TABLE [SFIn].[gvp__Size__c] (
    ...
    [gvp__Liter_Volume__c]              DECIMAL (8, 6)   NULL,
    [gvp__Size_Key__c]                  NVARCHAR(40)     NULL,
    [gvp__X9_Liter_Eqv__c]              DECIMAL (12, 10) NULL,
    [gvp__Primary_Conversion__c]        DECIMAL (13, 11) NULL,
    [gvp__Secondary_Conversion__c]      DECIMAL (13, 11) NULL,
    [gvp__Standard_Bottles_Per_Case__c] DECIMAL (13, 11) NULL,
