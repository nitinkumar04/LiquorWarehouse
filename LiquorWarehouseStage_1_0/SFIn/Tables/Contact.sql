CREATE TABLE [SFIn].[Contact] (
    ...
    [MailingStreet]                    NVARCHAR (150)    NULL,
    ...
    [gvp__Favorite_Destination_s__c]   NVARCHAR (100)     NULL,
    [gvp__Favorite_Hotel_s__c]         NVARCHAR (100)     NULL,
    [gvp__Favorite_Product_s__c]       NVARCHAR (100)     NULL,
    [gvp__Favorite_Restaurants__c]     NVARCHAR (100)     NULL,
