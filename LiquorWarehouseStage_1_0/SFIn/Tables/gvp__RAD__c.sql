...
(
  ...
  [Id] char(18), 
	...
	gvp__Physical_Cases__c DECIMAL(16, 2) NOT null DEFAULT 0,
	...
	gvp__Dist_Item_Number__c varchar(255) NOT null DEFAULT '',
	gvp__Dist_Sales_Rep_Code__c VARCHAR(255) null,
	gvp__Extended_Price_2__c money null,
	gvp__Local_Tax__c money null,
	gvp__Source_System__c varchar(255) null,
...
CREATE INDEX [IX_gvp__RAD__c_Column] ON [SFIn].[gvp__RAD__c] ([gvp__Distributor__c], [gvp__Account__c], [gvp__Item__c], [gvp__Dist_Inv_Number__c], [gvp__Date__c], gvp__Dist_Item_Number__c)

GO

CREATE INDEX [IX_gvp__RAD__c_Column_1] ON [SFIn].[gvp__RAD__c] ([gvp__Distributor__c], [gvp__Account__c], [gvp__Item__c], [gvp__Date__c])
