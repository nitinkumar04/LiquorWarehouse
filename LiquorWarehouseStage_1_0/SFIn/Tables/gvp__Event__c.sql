CREATE TABLE [SFIn].[gvp__Event__c](
	...
	[gvp__Account_Management_Feedback__c] [varchar](max) NULL,
	...
	[gvp__Featured_Drink__c] [varchar](max) NULL,
	[gvp__Promotion_Description__c] [varchar](300) NULL,
