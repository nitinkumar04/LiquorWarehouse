CREATE TABLE [SFIn].[Account] (
    ...
    [gvp__Account_Key_List__c]                  VARCHAR (8000) NULL,
    [gvp__Account_Key__c]                       VARCHAR (20) NOT NULL,
    [gvp__Account_Rank__c]                      DECIMAL(4,1) NOT NULL,
    [gvp__Account_Segment__c]                   CHAR (18) NULL,
    [gvp__Account_Sold__c]                      DECIMAL(4,1) NOT NULL,
    ...
    [gvp__BDN_Date_of_Data__c]                  DATE  NULL,
    [gvp__BDN_Food_Type__c]                     VARCHAR (100)  NULL,
    [gvp__BDN_Id__c]                            VARCHAR (20)  NULL,
    [gvp__BDN_Last_Update__c]                   DATE  NULL,
    [gvp__BDN_Phone__c]                         VARCHAR (15)  NULL,
    ...
    [gvp__Consumer_Demo__c]                     NVARCHAR (100)  NULL,
    [gvp__County__c]                            NVARCHAR (25)  NULL,
    ...
    [gvp__Custom_10__c]                         NVARCHAR (200)  NULL,
    ...
    [gvp__Custom_8__c]                          NVARCHAR(200)  NULL,
    [gvp__Custom_9__c]                          NVARCHAR(200)  NULL,
    ...
    [gvp__Delivery_Day_Time__c]                 NVARCHAR(30)  NULL,
    [gvp__Dist_Acct_Number__c]                  VARCHAR (20)  NULL,
    ...
    [gvp__Franchise__c]                         VARCHAR (10) NOT NULL,
    [gvp__Geocode_Unavailable__c]               VARCHAR (10) NOT NULL,
    ...
    [gvp__Key_Account__c]                       VARCHAR (10) NOT NULL,
    [gvp__Last_Activity_Date__c]                DATE NOT NULL,
    ...
    [gvp__MSA_Name__c]                          VARCHAR (50)  NULL,
    ...
    [gvp__NumberofLocations__c]                 DECIMAL(4,1)  NULL,
    ...
    [gvp__Wine_Indicator__c]                    VARCHAR (10)  NULL,
