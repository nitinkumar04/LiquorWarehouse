...
(
  ...
  RecordTypeId char(18) not null,
	...
	gvp__Survey_Period__c char(18) not null,
	gvp__Account__c char(18) not null,
	gvp__Date_of_Survey__c date not null,
	gvp__Surveyed_by__c char(18) not null,
	...
	gvp__Email_Summary_Sent_Date__c datetime not null,
	gvp__Send_Email_Summary__c varchar(10) not null,
	gvp__Geolocation__Latitude__s decimal(14,11) not null,
	gvp__Geolocation__Longitude__s decimal(14,11) not null,
	gvp__Possible_Points__c decimal(4,1) not null,
	gvp__Plan_Possible_Points__c decimal(4,1) not null,
	gvp__Points_Since_Last_Survey__c decimal(4,1) not null,
	gvp__Previous_Survey__c char(18) null,
	gvp__Distance_m__c decimal(4,1) not null,
	gvp__Submitted_Date_Time__c datetime not null,
	gvp__Mobile_Survey__c varchar(10) not null,
	gvp__Source__c nvarchar(100) not null,
	gvp__Account_Team__c char(18) null,
	gvp__Audited__c varchar(10) not null,
	...
	gvp__Custom_Date_1__c datetime null,
	gvp__Custom_Date_2__c datetime null,
	...
	gvp__Most_Recent__c varchar(10) not null
