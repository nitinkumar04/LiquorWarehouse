...
(
  ...
  IsDeleted varchar(10) not null,
    ...
    [gvp__Adjustment_Type__c] VARCHAR(40) NULL, 
    [gvp__BI_Reporting_Tool__c] VARCHAR(40) NULL, 
    [gvp__BI_Url__c] VARCHAR(100) NULL, 
    [gvp__Description__c] VARCHAR(100) NULL, 
    ...
    [gvp__Partner_Server_Url__c] VARCHAR(100) NULL, 
    [gvp__Profile_Id__c] CHAR(18) NULL, 
    [gvp__Project_Id__c] CHAR(30) NOT NULL, 
    [gvp__Sales_Goal_Filter_By_Goal_Plan__c] NCHAR(10) NULL, 
    [gvp__Save_Report_Definition__c] NCHAR(10) NULL, 
    [gvp__Set_Goal__c] VARCHAR(40) NULL,
