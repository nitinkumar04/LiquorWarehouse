CREATE TABLE [GVW].[Geography_Dim]
(
	[Geography Dim Id] 				    VARCHAR(18) NOT NULL,
	...
	[Distributor Owner Id] 			  VARCHAR(18) NULL,
	...
	[Distributor Id]	 	      		VARCHAR(18) NULL,
    ...
    CONSTRAINT [PK_Geography_Dim] PRIMARY KEY ([Geography Dim Id])  
)
