CREATE TABLE [GVW].[Promo_Event_Fact](
	[Promo_Event_Fact_Id] VARCHAR(18) NOT NULL,
	[Promo_Event_Fact_Type] [varchar](50) NULL,
	[Account_Call_Fact_Id] VARCHAR(18) NULL,
	[Activity_Fact_Id] VARCHAR(18) NULL,
	[Spend_Dim_Id] VARCHAR(18) NULL,
	[Txn_Type_Id] [varchar](50) NULL,
	[Activity_Goal_Dim_Id] VARCHAR(18) NULL,
	[Geography_Dim_Id] VARCHAR(18) NULL,
	[Currency_Dim_Id] [varchar](50) NULL,
	[Contact_Dim_Id] VARCHAR(18) NULL,
	[Account_Dim_Id] VARCHAR(18) NULL,
	[Acct_Univ_Dim_Id] VARCHAR(18) NULL,
	[Person_Dim_Id] VARCHAR(18) NULL,
	[Product_Dim_Id] VARCHAR(18) NULL,
	...
	[Promo_Event_Bartender_Feedback] [varchar](250) NULL,
	[Promo_Event_Customer_Feedback] [varchar](250) NULL,
	...
	CONSTRAINT [PK_Promo_Event_Fact] PRIMARY KEY ([Promo_Event_Fact_Id])
) ON [PRIMARY]
GO