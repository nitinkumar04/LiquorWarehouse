CREATE TABLE [GVW].[AcctUnivDim] (
    ...
    [AccountHierarchyDimID]          VARCHAR(18)  NULL,
    [AccountRetailDimID]             VARCHAR(18)  NULL,
    ...
    [AccountCustom1]                  NVARCHAR (255)  NULL,
    [AccountCustom2]                  NVARCHAR (255) NULL,
    [AccountCustom3]                  NVARCHAR (255) NULL,
    [AccountCustom4]                  NVARCHAR (255) NULL,
    [AccountCustom5]                  NVARCHAR (255) NULL,
    ...
    [LiquorIndicator]          VARCHAR (20)   NULL,
    [BeerIndicator]            VARCHAR (20)   NULL,
    ...
    [AccountCustomerPriority]         NVARCHAR (150) NULL,
    ...
    [MarketingGroupDimID]            VARCHAR(18) NULL,
    [AcctRecordTypeDimID]           VARCHAR(18) NULL,
    [AcctSegmentDimID]               VARCHAR(18) NULL,
    [CurrencyDimID]                   VARCHAR(18) NULL,
    [Description]               NVARCHAR (2000) NULL,
    [AccountCustomCheckbox1]         NVARCHAR (100)   NULL,
    [AccountCustomCheckbox2]         NVARCHAR (100)   NULL,
    [AccountCustom6]                  NVARCHAR (255)  NULL,
    [AccountCustom7]                  NVARCHAR (255)  NULL,
    [AccountCustom8]                  NVARCHAR (255)   NULL,
    [AccountCustom9]                  NVARCHAR (255)   NULL,
    [AccountCustom10]                 NVARCHAR (255)  NULL,
    ...
    [AccountCustomDate1]             VARCHAR (10) NULL,
    [AccountCustomDate2]             VARCHAR (10) NULL,
